...
import  {updateQuantityMedicine} from "../../../services/operations/Medicine"
const UpdateMedicine = () => {
   ...
   function handleOnSubmit(e){
       e.preventDefault();
       console.log("PRINTING THE FORM DATA IN THE UPDATE QUANTITY PAGE",formData);
       dispatch(updateQuantityMedicine(token,formData,navigate));
   }
  return (
    <>
     <form onSubmit={handleOnSubmit}>
        <h1 className="mb-14 text-3xl font-medium text-richblack-5">
          Update The Added Medicine Quantity
        </h1>
